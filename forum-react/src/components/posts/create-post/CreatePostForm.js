        ...
        return (
            <form className="form-group text-center" onSubmit={this.props.onSubmitHandler}>
                ...
                <div className="col-md-6">
                    ...
                    <RequirementMessage message={"* Maximum length: 50 characters"}
                                        fieldOnFocus={this.state.titleOnFocus}/>
                </div>
                <div className="col-md-12">
                    ...
                    <RequirementMessage message={"* Maximum length: 2000 characters"}
                                        fieldOnFocus={this.state.contentOnFocus}/>
                </div>
                <div className="col-md-12">
